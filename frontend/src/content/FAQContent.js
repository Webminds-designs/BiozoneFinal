const faqContent = {
	en: {
		...
		questions: [
			...
			},
			{
				...
				a: "Yes, course materials are available for download after enrollment.",
			},
			{
	...
	si: {
		...
		description:
			"ඔබ සොයන පිළිතුර සොයාගත නොහැකිද? කරුණාකර අපගේ මිතුරු කණ්ඩායම සමඟ කතා කරන්න.",
		questions: [
			{
			...
			},
			{
				...
				a: "ඔව්, ලියාපදිංචි වීමෙන් පසු පාඨමාලා ද්‍රව්‍ය බාගත කිරීමට හැක.",
			},
			{
				q: "පන්තියක් සඳහා ගෙවීම් කරන ආකාරය කුමක්ද?",
				a: "ඔබට ක්‍රෙඩිට් කාඩ්පත, PayPal හෝ බැංකු ගිණුමට මුදල් යැවීම හරහා ගෙවීම් කළ හැක.",
			},
			// ...more questions
		],
	},
